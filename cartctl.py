...
class CartCtl:
    ...
    def heartbeat(self):
        ...
        # TODO: Uncomment this line for fix Error no. 2
        # if cargo_req or any(s.prio for s in self.cart.slots if s is not None):
        if cargo_req:
        ...
        if slot != -1:
            ...
            return
        # TODO: Comment this line for fix Error no. 1
